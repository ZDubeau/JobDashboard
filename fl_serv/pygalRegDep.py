...
def region_offre(regions,profondeur):
    ...
    fr_chart.render_to_file("fl_serv/static/image/carte_region_"+profondeur+".svg")
    return "carte_region_"+profondeur+".svg"
...
def dep_offre(departements,profondeur):
    ...
    fr_chart.render_to_file("fl_serv/static/image/carte_departement_"+profondeur+".svg")

    return "carte_departement_"+profondeur+".svg"
...
def pie_chart(df,profondeur,unite):
    ...
    if unite == "r":
        ...
        return "pie_chart_regions_"+profondeur+".svg"
    elif unite == "d":
        pie_chart.render_to_file("fl_serv/static/image/pie_chart_departement_"+profondeur+".svg")   
        return "pie_chart_departement_"+profondeur+".svg"
        ...
        if not sql == "" :
            ...
            if len(resultat) > 0:
                ...
                if unite == "r":
                    ...
                    nom_carte = region_offre(df,profondeur)
